...
import app.users.core.Constants.EMPTY_CONTEXT_PATH
import app.users.core.Constants.EMPTY_STRING
import app.users.core.Constants.HTTP
import app.users.core.Constants.HTTPS
import app.users.core.Constants.LINE
import app.users.core.Constants.PRODUCTION
import app.users.core.Constants.SERVER_PORT
import app.users.core.Constants.SERVER_SERVLET_CONTEXT_PATH
import app.users.core.Constants.SERVER_SSL_KEY_STORE
import app.users.core.Constants.SPRING_APPLICATION_NAME
import app.users.core.Constants.STARTUP_HOST_WARN_LOG_MSG
